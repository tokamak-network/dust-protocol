        ...
        <Box w="100%" maxW="440px">
          {isResolving ? (
            <VStack gap="20px" py="48px">
              ...
              <Text fontSize="14px" color={colors.text.muted}>Resolving {fullName}...</Text>
            </VStack>
          ) : notFound ? (
            <VStack gap="20px" py="48px" textAlign="center">
              <AlertCircleIcon size={48} color={colors.accent.red} />
              <Text fontSize="18px" fontWeight={600} color={colors.text.primary}>{fullName} not found</Text>
            ...
            <Box bgColor={colors.bg.card} borderRadius={radius.xl} border={`1.5px solid ${colors.border.default}`}
              ...
              <Box p="24px" borderBottom={`1px solid ${colors.border.default}`}
                ...
                <VStack gap="8px">
                  ...
                  <Text fontSize="20px" fontWeight={700} color={colors.accent.indigoBright}>{fullName}</Text>
                ...
                {!isConnected ? (
                    ...
                    <Box p="20px" bgColor={colors.bg.input} borderRadius={radius.md} border={`1px solid ${colors.border.default}`}>
                      <VStack gap="14px" align="stretch">
                        ...
                        <HStack justify="space-between">
                          ...
                          <Text fontSize="15px" fontWeight={600} color={colors.accent.indigoBright}>{fullName}</Text>
                        </HStack>
                      </VStack>
                    </Box>
                  ...
                  <VStack gap="24px" py="12px">
                    ...
                    <VStack gap="6px">
                      ...
                      <Text fontSize="13px" color={colors.text.muted} textAlign="center">{amount} TON sent to {fullName}</Text>
                    </VStack>
                    {sendTxHash && (
