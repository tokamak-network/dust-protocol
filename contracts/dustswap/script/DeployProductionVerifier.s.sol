...
import {DustSwapVerifierProduction} from "../src/DustSwapVerifierProduction.sol";
...
contract DeployProductionVerifier is Script {
    function run() external {
        ...
        console.log("Deploying DustSwapVerifierProduction...");

        vm.startBroadcast(deployerPrivateKey);

        DustSwapVerifierProduction verifier = new DustSwapVerifierProduction();
